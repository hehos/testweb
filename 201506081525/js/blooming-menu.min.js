...
!function () {
    ...
    function n(e) {
        ...
        e.elements.styleSheet = document.createElement("style"), document.head.appendChild(e.elements.styleSheet), e.elements.container = document.createElement("div"), e.elements.container.classList.add(t + p), e.elements.mainContainer = document.createElement("div"), e.elements.mainContainer.classList.add(t + d), e.elements.main = document.createElement("button"), e.elements.main.classList.add(t + u), e.elements.mainContent = document.createElement("span"), e.elements.mainContent.classList.add(t + f), e.elements.mainContent.innerHTML = e.mainContent, e.elements.mainContainer.appendChild(e.elements.main), e.elements.main.appendChild(e.elements.mainContent), e.elements.container.appendChild(e.elements.mainContainer), e.elements.items = [], e.elements.itemsContainer = document.createElement("ul"), e.elements.itemsContainer.classList.add(t + h), e.elements.container.appendChild(e.elements.itemsContainer);
        for (var n = 0; n < e.itemsNum; n++) {
            ...
            s.classList.add(t + x), a.appendChild(s), i.appendChild(a), e.elements.itemsContainer.appendChild(i), e.elements.items.push(i)
        }
    ...
    function s(e) {
        var t = (e.endAngle - e.startAngle) / (e.itemsNum - 1), n = e.startAngle, i = "", a = e.CSSClassPrefix;
        e.elements.items.forEach(function (s, r) {
            var m = e.radius * Math.cos(o(n)), l = e.radius * Math.sin(o(n)), c = Number(m.toFixed(2)), p = Number(l.toFixed(2)), d = 1.2 * c, u = 1.2 * p, f = 0, h = 0;
    ...
    function c(e) {
        e.props.elements.main.removeEventListener("click"), e.props.elements.main.removeEventListener("touchstart")
    }

    var p = "container", d = "main-container", u = "main", f = "main-content", h = "items", b = "item-btn-wrapper", w = "item", x = "item-btn";
    e.prototype.render = function () {
        var e = "";
        return n(this.props), this.props.injectBaseCSS && (e = i(this.props), a(e, this.props.elements.styleSheet)), s(this.props), l(this), this
        ...
        var t = this, n = document.querySelector(".blooming-menu__item-btn-wrapper");
