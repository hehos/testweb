document.writeln("<div class=\"wlwm\">");
document.writeln("                <div class=\"wklx\">");
document.writeln("                    <span id=\"prevTop\"></span>");
document.writeln("                    <span id=\"nextTop\"></span>");
document.writeln("                    <div id=\"picBox\" class=\"picBox\">");
document.writeln("                        <ul class=\"cf\">");

document.writeln("<li><a href=\"/zhuanjia/lal/\"><img src=\"/images/t_zj2.jpg\" /></a></li>");
document.writeln("<li><a href=\"/zhuanjia/jwz/\"><img src=\"/images/t_zj3.jpg\" /></a></li>");
document.writeln("<li><a href=\"/zhuanjia/dyw/\"><img src=\"/images/t_zj4.jpg\" /></a></li>");


document.writeln("                        </ul>");
document.writeln("                    </div>");
document.writeln("                    <div id=\"prev\" class=\"prev\"></div>");
document.writeln("                    <div id=\"listBox\" class=\"listBox\"> ");
document.writeln("                        <ul class=\"cf\">");
document.writeln("<li class=\"on\"><a href=\"/zhuanjia/sy/\"><img src=\"/images/t_zj2a.jpg\" /></a><span></span></li>");
document.writeln("<li><a href=\"/zhuanjia/jwz/\"><img src=\"/images/t_zj3a.jpg\" /></a><span></span></li>");
document.writeln("<li><a href=\"/zhuanjia/dyw/\"><img src=\"/images/t_zj4a.jpg\" /></a><span></span></li>");

document.writeln("                        </ul>");
document.writeln("                    </div>");
document.writeln("                    <div id=\"next\" class=\"next\"></div>");
...
document.writeln("                        }");
document.writeln("                    ");
document.writeln("                        var oPic = G(\"picBox\");");
document.writeln("                    ");
document.writeln("                        var oList = G(\"listBox\");");
document.writeln("                        ");
document.writeln("                        var oPrev = G(\"prev\");");
document.writeln("                        var oNext = G(\"next\");");
document.writeln("                        var oPrevTop = G(\"prevTop\");");
document.writeln("                        var oNextTop = G(\"nextTop\");");
document.writeln("                    ");
